...
{
  /**
   * Returns the value of the '<em><b>Expressoes</b></em>' attribute list.
   * The list contents are of type {@link java.lang.String}.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Expressoes</em>' attribute list isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Expressoes</em>' attribute list.
   * @see org.xtext.example.exp1.exp1.Exp1Package#getExp1_Expressoes()
   * @model unique="false"
   * @generated
   */
  EList<String> getExpressoes();
