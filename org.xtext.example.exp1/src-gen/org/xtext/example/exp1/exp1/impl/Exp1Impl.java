...
{
  /**
   * The cached value of the '{@link #getExpressoes() <em>Expressoes</em>}' attribute list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getExpressoes()
   * @generated
   * @ordered
   */
  protected EList<String> expressoes;
   ...
   * @generated
   */
  public EList<String> getExpressoes()
  {
    if (expressoes == null)
    {
      expressoes = new EDataTypeEList<String>(String.class, this, Exp1Package.EXP1__EXPRESSOES);
    }
    return expressoes;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case Exp1Package.EXP1__EXPRESSOES:
        getExpressoes().clear();
        getExpressoes().addAll((Collection<? extends String>)newValue);
        return;
    }
