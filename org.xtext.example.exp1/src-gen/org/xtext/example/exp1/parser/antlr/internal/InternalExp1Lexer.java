...
public class InternalExp1Lexer extends Lexer {
    ...
    public final void mT__14() throws RecognitionException {
        try {
            ...
            // InternalExp1.g:11:7: ( 'or' )
            // InternalExp1.g:11:9: 'or'
            {
            match("or"); 
    ...
    public final void mT__15() throws RecognitionException {
        try {
            int _type = T__15;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalExp1.g:12:7: ( 'and' )
            // InternalExp1.g:12:9: 'and'
            {
            match("and"); 
    ...
    public final void mRULE_VALORBOOLEANO() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalExp1.g:491:20: ( ( 'true' | 'false' ) )
            // InternalExp1.g:491:22: ( 'true' | 'false' )
            {
            // InternalExp1.g:491:22: ( 'true' | 'false' )
            int alt2=2;
    ...
    public final void mRULE_VALORSTRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalExp1.g:493:18: ( ( 'a' .. 'z' )? )
            // InternalExp1.g:493:20: ( 'a' .. 'z' )?
            {
            // InternalExp1.g:493:20: ( 'a' .. 'z' )?
            int alt3=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalExp1.g:495:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalExp1.g:495:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalExp1.g:495:11: ( '^' )?
            int alt4=2;
            ...
            // InternalExp1.g:495:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop5:
            do {
                int alt5=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalExp1.g:497:10: ( ( '0' .. '9' )+ )
            // InternalExp1.g:497:12: ( '0' .. '9' )+
            {
            // InternalExp1.g:497:12: ( '0' .. '9' )+
            int cnt6=0;
            loop6:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalExp1.g:499:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalExp1.g:499:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalExp1.g:499:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    // InternalExp1.g:499:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalExp1.g:499:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
                    ...
                    break;
                case 2 :
                    // InternalExp1.g:499:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalExp1.g:499:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop8:
                    do {
                        int alt8=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalExp1.g:501:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalExp1.g:501:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalExp1.g:501:24: ( options {greedy=false; } : . )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalExp1.g:503:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalExp1.g:503:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalExp1.g:503:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop11:
            do {
                int alt11=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalExp1.g:505:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalExp1.g:505:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalExp1.g:505:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt14=0;
            loop14:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalExp1.g:507:16: ( . )
            // InternalExp1.g:507:18: .
            {
            matchAny(); 
    ...
    static final String DFA15_eotS =
        "\3\14\1\24\1\32\1\uffff\2\14\1\36\3\14\1\uffff\1\24\2\uffff\3\24\2\uffff\1\47\1\uffff\1\26\4\uffff\2\26\1\uffff\1\36\2\26\6\uffff\1\55\1\56\3\26\2\uffff\1\26\1\63\2\26\1\uffff\1\63\1\66\1\uffff";
    static final String DFA15_eofS =
        "\67\uffff";
    static final String DFA15_minS =
        "\1\0\2\60\1\75\1\53\1\uffff\6\60\1\uffff\1\101\2\uffff\2\0\1\52\2\uffff\1\60\1\uffff\1\144\4\uffff\1\164\1\156\1\uffff\1\60\1\165\1\154\6\uffff\2\60\1\147\1\145\1\163\2\uffff\1\164\1\60\1\145\1\150\1\uffff\2\60\1\uffff";
    static final String DFA15_maxS =
        "\1\uffff\2\172\1\75\1\53\1\uffff\2\172\1\71\3\172\1\uffff\1\172\2\uffff\2\uffff\1\57\2\uffff\1\172\1\uffff\1\144\4\uffff\1\164\1\156\1\uffff\1\71\1\165\1\154\6\uffff\2\172\1\147\1\145\1\163\2\uffff\1\164\1\172\1\145\1\150\1\uffff\2\172\1\uffff";
    static final String DFA15_acceptS =
        "\5\uffff\1\5\6\uffff\1\13\1\uffff\1\14\1\15\3\uffff\1\21\1\22\1\uffff\1\14\1\uffff\1\3\1\6\1\4\1\5\2\uffff\1\11\3\uffff\1\15\1\16\1\17\1\20\1\21\1\1\5\uffff\1\2\1\7\4\uffff\1\12\2\uffff\1\10";
    static final String DFA15_specialS =
        "\1\1\17\uffff\1\0\1\2\45\uffff}>";
    static final String[] DFA15_transitionS = {
            "\11\24\2\23\2\24\1\23\22\24\1\23\1\24\1\20\4\24\1\21\3\24\1\4\1\24\1\5\1\24\1\22\1\17\11\10\3\24\1\3\3\24\32\16\3\24\1\15\1\16\1\24\1\2\4\13\1\12\5\13\1\7\1\13\1\6\1\1\4\13\1\11\6\13\uff85\24",
            "\12\26\7\uffff\32\26\4\uffff\1\26\1\uffff\21\26\1\25\10\26",
            "\12\26\7\uffff\32\26\4\uffff\1\26\1\uffff\15\26\1\27\14\26",
            "\1\30",
            "\1\31",
            "",
            "\12\26\7\uffff\32\26\4\uffff\1\26\1\uffff\16\26\1\34\13\26",
            "\12\26\7\uffff\32\26\4\uffff\1\26\1\uffff\4\26\1\35\25\26",
            "\12\37",
            "\12\26\7\uffff\32\26\4\uffff\1\26\1\uffff\21\26\1\40\10\26",
            "\12\26\7\uffff\32\26\4\uffff\1\26\1\uffff\1\41\31\26",
